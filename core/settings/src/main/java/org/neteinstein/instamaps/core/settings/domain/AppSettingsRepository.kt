...
/**
 * Persists user-editable app settings - currently just the Places API key entered on the
...
interface AppSettingsRepository {
    ...
    fun observePlacesApiKey(): Flow<String?>

    /** Trims [apiKey] before storing; an empty result clears any previously saved key. */
    suspend fun savePlacesApiKey(apiKey: String)
}
