...
class GetReelInfoUseCaseTest {
    ...
    @Test
    fun `invoke returns failure for non-Instagram URL`() =
        runTest {
    ...
    @Test
    fun `invoke returns failure for empty URL`() =
        runTest {
            val result = useCase("")
            assertTrue(result.isFailure)
        }
    ...
    @Test
    fun `invoke calls repository for valid Instagram URL`() =
        runTest {
    ...
    @Test
    fun `invoke calls repository for instagr am short URL`() =
        runTest {
